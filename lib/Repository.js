...
exports.Repository = exports.RepositoryChangeType = void 0;
...
var RepositoryChangeType;
(function (RepositoryChangeType) {
    RepositoryChangeType["ADDED"] = "ADDED";
    RepositoryChangeType["MODIFIED"] = "MODIFIED";
    RepositoryChangeType["DELETED"] = "DELETED";
})(RepositoryChangeType = exports.RepositoryChangeType || (exports.RepositoryChangeType = {}));
var Repository = /** @class */ (function () {
    ...
    Repository.prototype.onChange = function (handler, filter) {
        var dbChanges = this._createDbChangeListener(handler, filter);
    ...
    Repository.prototype.removeOnChangeListener = function (handler) {
        var index = this.changeListeners.findIndex(function (h) { return h.handler === handler; });
        if (index > -1) {
    ...
    Repository.prototype.removeAllChangeListener = function () {
        this.changeListeners.forEach(function (cl) { return cl.dbChanges.cancel(); });
        this.changeListeners = [];
    };
    Repository.prototype._isNew = function (entity) {
        return entity._id === undefined;
    };
    Repository.prototype._createDbChangeListener = function (handler, filter) {
        return this.db
            .changes({
            since: 'now',
            live: true,
            ...
            else if ((_a = change.doc) === null || _a === void 0 ? void 0 : _a._rev.startsWith('1-')) {
